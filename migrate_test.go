...
import (
	dStub "github.com/brettbuddin/migrate/v4/database/stub"
	"github.com/brettbuddin/migrate/v4/source"
	sStub "github.com/brettbuddin/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/brettbuddin/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/brettbuddin/migrate/v4/source/stub"`
